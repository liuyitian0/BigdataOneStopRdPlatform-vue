<template>
  <el-container>
    ...
    <el-main>
      ...
      <div id="c0">
        <div id="c1">调度任务概述</div>
        <div id="c2">调度运行时常/周</div>
        <div id="c3">错误任务</div>
      </div>

      <div class="c00">
        <div id="c5">慢任务Top 10 (负责人)</div>
      </div>
      <div class="c00">
        <div id="c4">核心表数据量/表主键监控</div>
      </div>
      <div class="c000">
        <div id="c6">目前定时 Flow 列表</div>
        <div id="c7"></div>
        <div id="c8"></div>
        <div id="c9">排班调整</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    initReport3() {
      ...
      chart.interval().position("type*value").color("#FF0000").size(26);
      // .label('value', {
      //   style: {
      //     fill: '#8d8d8d',
      //   },
